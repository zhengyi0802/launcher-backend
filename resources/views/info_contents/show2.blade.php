...
@section('content')
    ...
    <form action="{{ route('announce_contents.newstore', $project->id) }}" method="POST" enctype="multipart/form-data" >
         @csrf
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div id="div-preview">
                        <img src="{{ $announceContent->url }}" name="preview" id="preview" >
                    </div>
                </div>
                <script>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>描述:</strong>
                    <textarea class="form-control" style="height:150px" name="detail" placeholder="描述">{{ $announceContent->detail }}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>狀態:  </strong>
                    <input type="radio" name="status" value="1" {{ ($announceContent->status==1) ? "checked":null }} >啟用
                    <input type="radio" name="status" value="0" {{ ($announceContent->status!=1) ? "checked":null }} >不啟用
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>起始時間:</strong>
                    <input type="datetime_local" name="start_datetime" value="{{ $announceContent->start_datetime }}" class="form-control" placeholder="YYYY-MM-DD hh:mm:ss">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>終止時間:</strong>
                    <input type="datetime_local" name="stop_datetime" value="{{ $announceContent->stop_datetime }}" class="form-control" placeholder="YYYY-MM-DD hh:mm:ss">
                </div>
            </div>
